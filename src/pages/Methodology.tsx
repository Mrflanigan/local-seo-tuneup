...
const categories = [
  ...
  },
  {
    ...
    checks: [
      ...
      {
        id: "speed-proxies", name: "Page weight & third-party scripts", pts: 2,
      ...
      {
        id: "robots-txt", name: "robots.txt presence", pts: 2,
        what: "We check if your site has a robots.txt file and whether it's accidentally blocking Google.",
        why: "robots.txt tells Google which pages to crawl and which to skip. A missing file won't break anything, but a misconfigured one (like 'Disallow: /') can hide your entire site from search results.",
        fix: "Most website platforms generate robots.txt automatically — check your platform's settings. If you have one, make sure it doesn't contain 'Disallow: /' unless you intend to block Google.",
      },
      {
        id: "xml-sitemap", name: "XML sitemap", pts: 2,
        what: "We look for an XML sitemap at common locations and check if it's referenced in your robots.txt.",
        why: "A sitemap is like a table of contents for Google — it helps discover and index all your pages, especially service pages, location pages, and blog posts that might not be linked prominently.",
        fix: "Most website platforms can generate a sitemap automatically (check your SEO settings or install a plugin). Then add a 'Sitemap:' line to your robots.txt pointing to it.",
      },
    ],
  },
  {
