  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-end justify-center overflow-hidden pb-16">
        ...
        <div className="absolute top-20 right-6 z-20 flex items-start gap-2 text-left">
        ...
        <p className="absolute top-[14rem] sm:top-[15rem] left-6 z-10 text-sm sm:text-base text-foreground/70 leading-relaxed max-w-lg italic" style={{ fontFamily: "'Bookman Old Style', 'URW Bookman', 'Bookman', serif" }}>
            Only, <span className="text-primary font-bold not-italic">Osmosis™</span>, prioritizes customer demand up front — and we own it.
        </p>
