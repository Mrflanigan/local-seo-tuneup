...
{
  "interpretation": {
    "what_you_do": "one sentence, 12-22 words, plain English, respectful and professional. Read the description CAREFULLY and identify the actual core service. Describe what the customer GETS — the outcome and the thing the business does for them. If the description is about MOVING (relocating people/households/offices), the sentence MUST clearly say they move belongings/households from one place to another (e.g., 'You move households and their belongings from one home to another, handling packing, loading, transport, and setup at the new place.'). If the description is about JUNK REMOVAL, say so explicitly — never confuse the two. Strong, hands-on language is welcome ('muscle', 'crew', 'careful loading', 'safe transport') when it flatters the trade. ABSOLUTELY FORBIDDEN words and phrases: 'grunt', 'grunt work', 'menial', 'sweat', 'manual labor', 'junk', 'unwanted items', 'unwanted stuff', 'haul away', 'clutter', 'hoarder', 'pack rat', 'crap', 'mess', 'getting rid of'. Never imply the customer's belongings are worthless, unwanted, or a problem.",
